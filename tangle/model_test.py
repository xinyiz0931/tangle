...
class SepDirectionNet(nn.Module):
    ...
    def __init__(self,  in_channels=5, backbone='conv'):
        ...
        if backbone =='resnet':
            ...
            # self.image_feature_extractor = MLP(2048, image_feature_dim, [image_feature_dim])
            self.image_feature_extractor = MLP(8192, image_feature_dim, [image_feature_dim])
...
if __name__ == '__main__':
    ...
    model_ckpt = os.path.join(root_dir, "Checkpoint", "try_SR", "model_epoch_99.pth")
    # model_ckpt = os.path.join(root_dir, "Checkpoint", "try_new_res", "model_epoch_12.pth")
    batch_size = 1
